...
def save_data_to_excel(df):
    ...
    columns = ['position_name', 'cloudrate', 'dswrf', 'humidity', 'precipitation', 'pressure', 'skycon', 'temperature', 'visibility','wd', 'ws', 'pm25', 'aqi']
...
def save_data_to_database(df):
    ...
    for index, row in df.iterrows():
        dbMlmet.insert(dt, row['position_name'], row['precipitation'], row['temperature'], row['ws'],
